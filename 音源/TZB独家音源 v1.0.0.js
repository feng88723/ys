/**
 * @name TZB独家音源
 * @description 支持kw ,kg ,wy flac音质
 * @version 1.0.0
 * @author TZB679
 * @homepage https://github.com/TZB679/USEFUL-LX-MUSIC-SOURCES/
 * @license MIT
 * 
 * 支持平台: 酷我音乐、酷狗音乐、网易云音乐
 * 支持音质: 128k, 320k, flac
 * 生成时间: 2026-03-29T06:27:20.330Z
 */
...
const SUPPORTED_SOURCES = ["kw","kg","wy"]
const ALLOWED_QUALITIES = ["128k","320k","flac"]
const SCRIPT_VERSION = 'TZB独家音源_v1.0.0'
const SCRIPT_ID = 'cmnbdmela0000s9e7perzh70l'
const CARD_KEY = 'TF-LUQ1-PHST-B5OS-SK3Q'
